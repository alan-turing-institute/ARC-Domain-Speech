...
class TestRoundRobin:
    def test_equal_length(self):
        list1 = [1, 2, 3]
        list2 = ["a", "b", "c"]
        result = list(callhome_utils._roundrobin(list1, list2))
    ...
    def test_single_input(self):
        list1 = [1, 2]
        result = list(callhome_utils._roundrobin(list1))
        assert result == [1, 2]
    ...
    def test_multiple_lists(self):
        ...
        result = list(callhome_utils._roundrobin(list1, list2, list3, list4))
        assert result == [1, "a", True, 0.1, 2, False, 0.2, 3, 0.3, 0.4, 0.5]

    def test_no_input(self):
        result = list(callhome_utils._roundrobin())
        assert result == []
...
class TestFillGaps:
    def test_fill_gaps_basic(self):
        ...
        filled = callhome_utils._fill_gaps(sample)
